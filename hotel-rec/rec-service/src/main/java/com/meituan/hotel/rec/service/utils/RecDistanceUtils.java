...
public class RecDistanceUtils {
     ...
     * 2. 计算球面距离
     */
    public static double calDistance(double longitude1, double latitude1, double longitude2, double latitude2)
    {
    ...
    public static double calDistance(Location locationA, Location locationB){
        if (isValidLocation(locationA) && isValidLocation(locationB)) {
            return calDistance(locationA.longitude, locationA.lattitude, locationB.longitude, locationB.lattitude);
        }
    ...
    public static boolean isValidLocation(Location location){
        return location != null
                && location.getLattitude() > EPSILON
                && location.getLongitude() > EPSILON;
    }
    ...
    public static String location2String(Location location){
        ...
        sb.append(location.getLattitude()).append(Constants.SEPERATOR_COMMA).append(location.getLongitude());
        return sb.toString();
    }
}
