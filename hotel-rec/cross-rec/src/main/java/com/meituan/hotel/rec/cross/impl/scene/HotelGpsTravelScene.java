 ...
 */
public class HotelGpsTravelScene extends SceneClass{

    private static final Logger logger = LoggerFactory.getLogger(HotelGpsTravelScene.class);
    ...
    public List<TravelOrHotelPoiInfo> recommendTravelOrHotel(JSONObject jsodLog, CrossRecRequest request, CrossRecResponse response){
        ...
        logger.info(AvailField.HOTEL_GPS_TRAVEL_TIME + costTime + "ms");
        JMonitor.add(JMonitorKey.HOTEL_GPS_TRAVEL_TIME, costTime);
        return poiList;
    }
}
