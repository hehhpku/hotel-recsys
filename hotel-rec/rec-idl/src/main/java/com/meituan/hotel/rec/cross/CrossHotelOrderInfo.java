...
public class CrossHotelOrderInfo implements org.apache.thrift.TBase<CrossHotelOrderInfo, CrossHotelOrderInfo._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CrossHotelOrderInfo");
  ...
  private static final org.apache.thrift.protocol.TField DATE_CHECKIN_FIELD_DESC = new org.apache.thrift.protocol.TField("dateCheckin", org.apache.thrift.protocol.TType.I64, (short)8);
  private static final org.apache.thrift.protocol.TField DATE_CHECHOUT_FIELD_DESC = new org.apache.thrift.protocol.TField("dateChechout", org.apache.thrift.protocol.TType.I64, (short)9);
  ...
  static {
    schemes.put(StandardScheme.class, new CrossHotelOrderInfoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CrossHotelOrderInfoTupleSchemeFactory());
  }
  ...
  public long dateCheckin; // optional
  public long dateChechout; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    DATE_CHECKIN((short)8, "dateCheckin"),
    DATE_CHECHOUT((short)9, "dateChechout"),
  ...
  private static final int __DATECHECKIN_ISSET_ID = 5;
  private static final int __DATECHECHOUT_ISSET_ID = 6;
  private BitSet __isset_bit_vector = new BitSet(7);
  private _Fields optionals[] = {_Fields.TYPE,_Fields.ORDERID,_Fields.POIIDS,_Fields.DEALID,_Fields.PRICE,_Fields.NUM,_Fields.ORDER_TIME,_Fields.DATE_CHECKIN,_Fields.DATE_CHECHOUT,_Fields.EXTRA_MAP};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CrossHotelOrderInfo.class, metaDataMap);
  }

  public CrossHotelOrderInfo() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public CrossHotelOrderInfo(CrossHotelOrderInfo other) {
  ...
  public CrossHotelOrderInfo deepCopy() {
    return new CrossHotelOrderInfo(this);
  }
   ...
   * @see OrderTypeEnum
   */
  public CrossHotelOrderInfo setType(OrderTypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public CrossHotelOrderInfo setOrderid(long orderid) {
  ...
  public CrossHotelOrderInfo setPoiids(List<PoiInfo> poiids) {
    this.poiids = poiids;
    return this;
  }
  ...
  public CrossHotelOrderInfo setDealid(long dealid) {
    this.dealid = dealid;
    setDealidIsSet(true);
    return this;
  }
  ...
  public CrossHotelOrderInfo setPrice(double price) {
    this.price = price;
    setPriceIsSet(true);
    return this;
  }
  ...
  public CrossHotelOrderInfo setNum(int num) {
    this.num = num;
    setNumIsSet(true);
    return this;
  }
  ...
  public CrossHotelOrderInfo setOrderTime(long orderTime) {
  ...
  public CrossHotelOrderInfo setDateCheckin(long dateCheckin) {
  ...
  public long getDateChechout() {
    return this.dateChechout;
  }

  public CrossHotelOrderInfo setDateChechout(long dateChechout) {
    this.dateChechout = dateChechout;
    setDateChechoutIsSet(true);
    return this;
  }

  public void unsetDateChechout() {
    __isset_bit_vector.clear(__DATECHECHOUT_ISSET_ID);
  }

  /** Returns true if field dateChechout is set (has been assigned a value) and false otherwise */
  public boolean isSetDateChechout() {
    return __isset_bit_vector.get(__DATECHECHOUT_ISSET_ID);
  }

  public void setDateChechoutIsSet(boolean value) {
    __isset_bit_vector.set(__DATECHECHOUT_ISSET_ID, value);
  }
  ...
  public CrossHotelOrderInfo setExtraMap(Map<String,String> extraMap) {
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case DATE_CHECKIN:
      return Long.valueOf(getDateCheckin());

    case DATE_CHECHOUT:
      return Long.valueOf(getDateChechout());
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CrossHotelOrderInfo)
      return this.equals((CrossHotelOrderInfo)that);
    return false;
  }

  public boolean equals(CrossHotelOrderInfo that) {
    if (that == null)
      return false;
    ...
    if (this_present_dateChechout || that_present_dateChechout) {
      if (!(this_present_dateChechout && that_present_dateChechout))
        return false;
      if (this.dateChechout != that.dateChechout)
        return false;
    }
  ...
  public int compareTo(CrossHotelOrderInfo other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    CrossHotelOrderInfo typedOther = (CrossHotelOrderInfo)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CrossHotelOrderInfo(");
    boolean first = true;
  ...
  private static class CrossHotelOrderInfoStandardSchemeFactory implements SchemeFactory {
    public CrossHotelOrderInfoStandardScheme getScheme() {
      return new CrossHotelOrderInfoStandardScheme();
    }
  }

  private static class CrossHotelOrderInfoStandardScheme extends StandardScheme<CrossHotelOrderInfo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CrossHotelOrderInfo struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.poiids = new ArrayList<PoiInfo>(_list0.size);
                for (int _i1 = 0; _i1 < _list0.size; ++_i1)
                {
                  PoiInfo _elem2; // required
                  _elem2 = new PoiInfo();
                  _elem2.read(iprot);
                  struct.poiids.add(_elem2);
                }
                iprot.readListEnd();
              }
          ...
          case 8: // DATE_CHECKIN
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.dateCheckin = iprot.readI64();
          ...
          case 9: // DATE_CHECHOUT
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.dateChechout = iprot.readI64();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i4 = 0; _i4 < _map3.size; ++_i4)
                {
                  ...
                  struct.extraMap.put(_key5, _val6);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CrossHotelOrderInfo struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.poiids != null) {
        if (struct.isSetPoiids()) {
          oprot.writeFieldBegin(POIIDS_FIELD_DESC);
          {
            ...
            for (PoiInfo _iter7 : struct.poiids)
            {
              _iter7.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class CrossHotelOrderInfoTupleSchemeFactory implements SchemeFactory {
    public CrossHotelOrderInfoTupleScheme getScheme() {
      return new CrossHotelOrderInfoTupleScheme();
    }
  }

  private static class CrossHotelOrderInfoTupleScheme extends TupleScheme<CrossHotelOrderInfo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CrossHotelOrderInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetPoiids()) {
        {
          ...
          for (PoiInfo _iter9 : struct.poiids)
          {
            _iter9.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CrossHotelOrderInfo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.poiids = new ArrayList<PoiInfo>(_list11.size);
          for (int _i12 = 0; _i12 < _list11.size; ++_i12)
          {
            PoiInfo _elem13; // required
            _elem13 = new PoiInfo();
            _elem13.read(iprot);
            struct.poiids.add(_elem13);
          }
        }
        struct.setPoiidsIsSet(true);
      }
      ...
      if (incoming.get(9)) {
        {
          ...
          for (int _i15 = 0; _i15 < _map14.size; ++_i15)
          {
            ...
            struct.extraMap.put(_key16, _val17);
          }
        }
        struct.setExtraMapIsSet(true);
      }
